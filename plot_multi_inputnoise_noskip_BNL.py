...
def mk_inoise_plot(module_name, input_files, stream="under", output_base_dir="BNL/HX"):
...
def main():
    ...
    parser.add_argument(
        ...
        "--output",
        default=None,
        help="Output base directory. Default is inferred from input path, e.g. BNL/HX",
    )
    ...
    output_base_dir = args.output or get_base_output_dir(input_files, "BNL/HX")
